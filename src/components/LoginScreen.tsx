  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#102225] text-fog">
      ...
      <div className="relative min-h-screen px-4 py-5 sm:px-6 lg:px-12">
        ...
        {isLogin && entry === "staff" && <div className="mt-4 rounded-xl border border-aurora-a/20 bg-aurora-a/8 px-2.5 py-2 text-xs leading-4 text-fog/70"><span>Demo staff access: <strong className="text-strong">staff@veridian.local</strong> / <strong className="text-strong">staff123</strong></span><button type="button" onClick={() => setMode("signup")} className="mt-1 block text-aurora-a underline-offset-2 hover:underline">Create a staff account</button></div>}
